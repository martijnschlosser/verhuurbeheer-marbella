...
const faqs = [
  [
    "How much does holiday rental management in Marbella cost?",
  ...
  [
    ...
    "Of course. We block your own stays in advance and align the rental strategy with the periods when you want to visit Marbella.",
  ],
  [
  ...
  [
    "Which areas of Marbella do you cover?",
    "We support owners in Marbella Pueblo, Golden Mile, La Cala de Marbella, Puerto Banús, Sierra Blanca, Marbella Golf, Los Monteros and Miraflores. Every property and location is assessed individually.",
  ],
  [
    "Do I need a rental licence for holiday rentals in Marbella?",
...
function LocalizedHome() {
  ...
  const schema = {
    ...
    description:
      "Full-service property management, holiday rental management and second-home care for owners in Marbella.",
    parentOrganization: {
      "@type": "Organization",
    ...
    areaServed: [
      ...
      { "@type": "Place", name: "Marbella Pueblo" },
      { "@type": "Place", name: "Golden Mile" },
      { "@type": "Place", name: "La Cala de Marbella" },
      { "@type": "Place", name: "Puerto Banús" },
      { "@type": "Place", name: "Sierra Blanca" },
      { "@type": "Place", name: "Marbella Golf" },
    ...
    image: absoluteUrl("/terras-zonsondergang-marbella.webp"),
    sameAs: [
    ...
    <main>
      ...
      <header className="site-header">
        <a
          ...
          href="/"
          aria-label="Property Management Marbella – Home"
        >
          <img
            src="/vbs-logo-marbella.webp"
            alt="Property Management Marbella logo"
            width="54"
            height="54"
          />
        </a>
        <nav>
          ...
          <details className="services-menu">
            ...
            <div>
              <a href="/vakantieverhuur-marbella/">Gestión de alquiler vacacional</a>
              <a href="/midterm-verhuur-marbella/">
                Alquiler de temporada
              </a>
              <a href="/langetermijnverhuur-marbella/">Alquiler de larga duración</a>
              <a href="/vastgoedbeheer-marbella/">Gestión de propiedades</a>
              ...
              <a href="/verhuurlicentie-marbella/">Licencia de alquiler</a>
            </div>
          </details>
        ...
        <details className="mobile-menu">
          ...
          <div>
            ...
            <b>Servicios</b>
            <a href="/vakantieverhuur-marbella/">Gestión de alquiler vacacional</a>
            <a href="/midterm-verhuur-marbella/">Alquiler de temporada</a>
            <a href="/langetermijnverhuur-marbella/">Alquiler de larga duración</a>
            <a href="/vastgoedbeheer-marbella/">Gestión de propiedades</a>
            <a href="/schoonmaak-onderhoud-marbella/">Limpieza y mantenimiento</a>
            <a href="/renovatie-inrichting-marbella/">Reforma y decoración</a>
            <a href="/verhuurlicentie-marbella/">Licencia de alquiler</a>
            <b>Company</b>
            <a href="/werkwijze/">Cómo trabajamos</a>
            <a href="/over-ons/">Quiénes somos</a>
      ...
      <section className="hero" id="top">
        ...
        <div className="hero-inner">
          ...
          <h1>Disfruta de tu segunda residencia en Marbella. Nosotros nos ocupamos del resto.</h1>
          <p>
            From Golden Mile and La Cala to Marbella Pueblo, we combine smart rental management with trusted local people. You have one clear contact for bookings, guests, cleaning, maintenance and the day-to-day care of your property.
          </p>
        ...
        <div className="hero-stats">
          ...
          <span>
            <CheckCircle2 aria-hidden="true" />
            <b>Local service</b> in Marbella and the surrounding area
          </span>
        </div>
      </section>
      ...
      <section
        ...
        aria-label="Homes and property in Marbella"
      >
        <figure className="showcase-wide">
          <img
            src="/villa-zwembad-marbella.webp"
            alt="Modern villa in Marbella with terrace, pool and sea views"
            width="1536"
            height="1024"
            loading="eager"
          />
        ...
        <figure>
          <img
            src="/villa-zwembad-marbella.webp"
            alt="Holiday home on the Marbella coast"
            width="1800"
            height="1118"
            loading="lazy"
          />
        ...
        <figure>
          <img
            ...
            alt="Luxury holiday home in Marbella with sea views"
            width="1600"
            height="1200"
            loading="lazy"
          />
      ...
      <aside className="license-note">
        ...
        <a href="/verhuurlicentie-marbella/">Read about rental licensing →</a>
      </aside>
      ...
      <section className="regions compact-regions" id="regios">
        <div className="section-head">
          ...
          <h2>Conocimiento local en todo Marbella</h2>
          <p>
            From coastal apartments and golf townhouses to hillside villas, we work throughout Marbella Pueblo, La Cala de Marbella, Golden Mile, Puerto Banús, Miraflores, Sierra Blanca and Marbella Golf.
          </p>
        </div>
        <div className="area-list" aria-label="Areas covered around Marbella">
          <b>Marbella Pueblo</b>
          <b>Golden Mile</b>
          <b>La Cala de Marbella</b>
          <b>Puerto Banús</b>
          <b>Sierra Blanca</b>
          <b>Marbella Golf</b>
          <b>Fuengirola</b>
      ...
      <section className="home-team">
        <div className="home-team-copy">
          ...
          <h2>Personal contact with people who know Marbella.</h2>
          <p>
      ...
      <section className="knowledge compact-knowledge" id="kennisbank">
        <div className="section-head">
          ...
          <p>
            Clear guidance on costs, rental strategy, regulations and property management in Marbella.
          </p>
        </div>
      ...
      <section className="faq">
        <div>
          ...
          <p>
            Key questions about our services and fees in Marbella.
          </p>
        </div>
        <div>
          {homeFaqs.map(([q, a], i) => (
      ...
      <section className="contact" id="contact">
        <div>
          ...
          <h2>Recibe una previsión de alquiler para tu vivienda en Marbella</h2>
          <p>
      ...
      <footer className="site-footer">
        <div className="footer-brand">
          <a className="logo-lockup" href="/" aria-label="Home">
            <img
              src="/vbs-logo-marbella.webp"
              alt="Property Management Marbella"
              width={640}
              height={640}
              sizes="54px"
            />
          ...
          <p>
            Property Management Marbella is part of{" "}
