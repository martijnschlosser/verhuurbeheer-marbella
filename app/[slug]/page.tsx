...
const seoH1BySlug: Record<string, string> = {
  "vakantieverhuur-marbella": "Vakantieverhuur in Marbella vanaf 18%",
  "midterm-verhuur-marbella": "Midterm verhuur in Marbella",
  "langetermijnverhuur-marbella": "Langetermijnverhuur in Marbella",
  "vastgoedbeheer-marbella": "Vastgoedbeheer in Marbella",
  "schoonmaak-onderhoud-marbella": "Schoonmaak en onderhoud in Marbella",
  "renovatie-inrichting-marbella": "Renovatie en inrichting in Marbella",
  "kosten-verhuurbeheer-marbella": "Wat kost verhuurbeheer in Marbella?",
  "dynamische-prijzen-vakantiewoning":
    "Dynamische prijzen voor een vakantiewoning in Marbella",
  "zelf-verhuren-of-verhuurbeheer":
    "Zelf verhuren of verhuurbeheer in Marbella?",
  "verhuurlicentie-marbella":
    "Verhuurlicentie in Marbella aanvragen en controleren",
  "over-ons": "Over Verhuurbeheer Marbella",
  werkwijze: "Werkwijze voor verhuurbeheer in Marbella",
  contact: "Contact met Verhuurbeheer Marbella",
  "woning-aanmelden": "Woning aanmelden voor verhuurbeheer in Marbella",
  blog: "Blogs over verhuurbeheer in Marbella",
};
...
export async function generateMetadata({
  ...
  return {
    ...
    twitter: {
      ...
      title: p.seoTitle,
      description: p.description,
      images: ["/marbella-hero.webp"],
    },
  };
}

const relatedBySlug: Record<string, string[]> = {
  "vakantieverhuur-marbella": [
    "verhuurlicentie-marbella",
    "kosten-verhuurbeheer-marbella",
    "dynamische-prijzen-vakantiewoning",
  ],
  "vastgoedbeheer-marbella": [
    "schoonmaak-onderhoud-marbella",
    "vakantieverhuur-marbella",
    "zelf-verhuren-of-verhuurbeheer",
  ],
  "midterm-verhuur-marbella": [
    "langetermijnverhuur-marbella",
    "vastgoedbeheer-marbella",
    "kosten-verhuurbeheer-marbella",
  ],
  "langetermijnverhuur-marbella": [
...
const contentVisualBySlug: Record<string, { src: string; alt: string }> = {
  "vakantieverhuur-marbella": {
    src: "/luxe-woning-marbella-zeezicht.webp",
    alt: "Luxe vakantiewoning in Marbella met lichte woonkamer en uitzicht op zee",
  },
  "midterm-verhuur-marbella": {
    src: "/luxe-interieur-marbella.webp",
    alt: "Licht ingericht appartement voor seizoens- en midtermverhuur in Marbella",
  },
  "langetermijnverhuur-marbella": {
    src: "/luxe-interieur-marbella.webp",
    alt: "Verzorgd interieur van een woning voor langetermijnverhuur in Marbella",
  },
  "vastgoedbeheer-marbella": {
    src: "/villa-zwembad-marbella.webp",
    alt: "Zwembad en mediterrane tuin bij een professioneel beheerde villa in Marbella",
  },
  "schoonmaak-onderhoud-marbella": {
    src: "/luxe-interieur-marbella.webp",
    alt: "Schoon en verzorgd interieur van een beheerde woning in Marbella",
  },
  "renovatie-inrichting-marbella": {
    src: "/terras-zonsondergang-marbella.webp",
    alt: "Luxe terras van een ingerichte woning in Marbella bij zonsondergang",
  },
  werkwijze: {
    src: "/zonnig-terras-zeezicht-marbella.webp",
    alt: "Zonnig terras van een beheerde vakantiewoning in Marbella met zeezicht",
  },
};
...
> = {
  "kosten-verhuurbeheer-marbella": {
    ...
    alt: "Woningen aan zee bij Marbella als illustratie bij de kosten van verhuurbeheer",
    category: "Kosten & tarieven",
    readTime: "4 min",
  },
  "dynamische-prijzen-vakantiewoning": {
    src: "/luxe-woning-marbella-zeezicht.webp",
    alt: "Luxe vakantiewoning met zeezicht in Marbella voor een blog over dynamische prijzen",
    category: "Opbrengst",
    readTime: "4 min",
  },
  "zelf-verhuren-of-verhuurbeheer": {
  ...
  "verhuurlicentie-marbella": {
    src: "/marbella-hero.webp",
    alt: "Uitzicht over Marbella bij informatie over de verhuurlicentie",
...
export default async function ContentRoute({
  ...
  const organization = {
    ...
    logo: {
      "@type": "ImageObject",
      url: absoluteUrl("/vbs-logo-marbella.webp"),
    },
  };
  const pageSchema =
    page.type === "gids"
  ...
  const trustItems =
    page.slug === "langetermijnverhuur-marbella"
      ? [
          <>
      ...
      : page.slug === "vastgoedbeheer-marbella"
        ? [
            <>
    ...
    <main className="content-page" id="top">
      ...
      <section className="content-hero">
        ...
        <aside>
          ...
          <strong>{page.price ?? "Marbella · Costa del Sol"}</strong>
          <p>
      ...
      {page.slug === "woning-aanmelden" && (
        <section className="signup-experience" id="woningformulier">
          ...
          <FormSubmit className="signup-form" action={leadFormAction} thankYouPath={siteConfig.template.thankYouPath}>
            ...
            <label>Locatie woning<input name="locatie" placeholder="Bijv. Golden Mile, Nueva Andalucía of Marbella Centro" required /></label>
        ...
        <section className="contact contact-page-form" id="woningformulier">
          ...
          >
            ...
            <label>
              ...
              <input
                name="locatie"
                placeholder="Bijv. Golden Mile of Marbella Centro"
                required
              />
            </label>
            <label>
      ...
      {page.slug === "blog" && featuredBlog ? (
        <section
          ...
          aria-label="Alle blogs over verhuurbeheer in Marbella"
        >
      ...
      {page.slug === "verhuurlicentie-marbella" && (
      ...
      {page.slug !== "blog" && page.slug !== "contact" && page.slug !== "woning-aanmelden" && (
        <section className="related">
          ...
          <h2>Meer voor eigenaren in Marbella</h2>
          <div>
            {related.map((r) => (
      ...
      {page.type === "gids" && (
        <section className="blog-lead">
          <div className="blog-lead-person">
            <img
              src="/sophie-marbella.webp"
              alt="Sophie van Verhuurbeheer Marbella"
              width={1088}
              height={1100}
          ...
          >
            ...
            <label>
              ...
              <input
                name="locatie"
                placeholder="Bijv. Marbella, Golden Mile of Cabopino"
              />
            </label>
            <label className="wide">
              Je vraag
      ...
      <footer className="site-footer">
        ...
        <div>
          ...
          <a href="/vastgoedbeheer-marbella/">Vastgoedbeheer</a>
          <a href="/verhuurlicentie-marbella/">Verhuurlicentie</a>
          <a href="/nederlandse-verhuurmakelaar-marbella/">Nederlandse verhuurmakelaar</a>
          <a href="/sleutelbeheer-marbella/">Sleutelbeheer</a>
          <a href="/appartement-verhuren-marbella/">Appartement verhuren</a>
          <a href="/villa-verhuren-marbella/">Villa verhuren</a>
          <a href="/airbnb-beheer-marbella/">Airbnb & Booking beheer</a>
          <a href="/tweede-woning-beheer-marbella/">Tweede woning beheer</a>
        </div>
        <div>
          <b>Meer</b>
          <a href="/werkwijze/">Werkwijze</a>
